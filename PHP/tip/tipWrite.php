        ...
        <div class="site">
            ...
            <div class="board">
                ...
                <div class="board__view">
                    <form name="tipWrite" action="tipWriteSave.php" method="post" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <section class="boardWrite">
                                <div style="display: flex; justify-content:space-between;">
                                    ...
                                    <div class="Title write">
                                        ...
                                        <input type="text" name="tipTitle" id="youtitle" placeholder="제목을 입력해주세요" class="input__style view-title edit write new" required>
                                    </div>
                                </div>
                                <div class="Desc">
                                    <label for="boardContents" class="ir">내용</label>
                                    <textarea name="tipContents" id="youCont" placeholder="내용을 입력해주세요" name="opinion" cols="20" rows="3" class="input__style view-cont edit" required></textarea>
                                </div>
                                <div class ="contImg">
                                    <label for="boardFile">이미지 첨부 : </label>
                                    <input type="file" name="tipFile" id="boardFile" accept=".jpg, .jpeg, .png, .gif" placeholder="jpg, gif, png 파일만 넣어주세요 :3">
                                 </div>
